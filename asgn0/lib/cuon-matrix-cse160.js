...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let v3 = new Vector3([y1 * z2 - z1 * y2, z1 * x2 - x1 * z2, x1 * y2 - y1 * x2]); // Modify this line to calculate cross product between other1 and other2.
    ...
    /**
      ...
      */
    magnitude() {
        // Insert your code here.  // Modify this line to calculate this vector's magnitude.
